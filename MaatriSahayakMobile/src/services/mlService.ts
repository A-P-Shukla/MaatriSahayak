...
const ML_API_URL = 'https://maatrisahyak-ml.onrender.com';
...
export const prepareMLInput = (
    ...
    return {
        ...
        Systolic_BP: vitals.systolic || vitals.bp_systolic || 120,
        Diastolic: vitals.diastolic || vitals.bp_diastolic || 80,
        BS: vitals.bloodSugar || vitals.blood_sugar || 5.5,
        Body_Temp: vitals.temperature || 98.6,
        BMI: pregnancy.bmi || 22.0,
        Previous_Complications: pregnancy.previousComplications ? 1 : 0,
        Preexisting_Diabetes: pregnancy.medicalHistory?.diabetes ? 1 : 0,
        Gestational_Diabetes: pregnancy.gestationalDiabetes ? 1 : 0,
        Mental_Health: pregnancy.mentalHealthConcerns ? 1 : 0,
        Heart_Rate: vitals.heartRate || vitals.heart_rate || 75,
    };
};
